...
const MovieDetails = () => {
    ...
    const getMovieDetails = async () => {
        const res = await axios.get(`https://api.themoviedb.org/3/movie/${param.id}?api_key=2aeabb633b5c9e4254abaf5dd51c8480&language=ar`)
        setMovie(res.data)
    }
    useEffect(() => {
        getMovieDetails();
        ...
        <div>
            <Row className="justify-content-center ">
                <Col md="12" xs="12" sm="12" className="mt-4 ">
                    <div className="card-detalis  d-flex align-items-center my-5  ">
                        <img
